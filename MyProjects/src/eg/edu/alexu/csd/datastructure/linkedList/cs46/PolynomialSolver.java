...
public class PolynomialSolver implements IPolynomialSolver {
  ...
  public int[][] add(char poly1, char poly2) {
    ...
    if (poly1 == poly2) {
      ...
      if (poly1 == 'A' && !Aexp.isEmpty()) {
        ...
        /*
         * if (poly2 == 'R') { arrayTwo = toArray(Rcoff, Rexp); setPolynomial('R', merge(arrayOne,
         * arrayTwo)); return merge(arrayOne, arrayTwo); }
         */
        if (poly2 == 'T') {
  ...
  private int[][] merge(int[][] poly1, int[][] poly2) {
    // TODO Auto-generated method stub
    int i = 0, j = 0, k = 0;
  ...
  private String printpoly(int[][] poly) {
    // TODO Auto-generated method stub
  ...
  private int[][] multi(int[][] poly1, int[][] poly2) {
    // TODO Auto-generated method stub
    int i, j;
    ...
    for (i = poly1[0][1] + poly2[0][1], j = 0; i >= poly1[poly1.length - 1][1]
  ...
  private int[][] toArray(OurSingleLinked a, OurSingleLinked b) {
  ...
  public boolean isValid(char poly) {
    if (poly == 'A') {
      if (!Aexp.isEmpty()) {
        return true;
      }
